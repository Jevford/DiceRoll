    ...
    implements ActionListener
{
    ...
    public void rollDice()
    {
        ...
        if(credit <= 0) {
        	JOptionPane.showMessageDialog(display, "You must have at least 1 credit to continue playing.", "Error", JOptionPane.WARNING_MESSAGE);
        }
        else if( 1 <= bet && bet <= credit){
        ...
        // If there is NOT a valid bet, a message should give a range of a valid bet
            ...
            JOptionPane.showMessageDialog(display, "Please enter a bet between 1 to " + Integer.toString(credit) + ".", "Error", JOptionPane.WARNING_MESSAGE);
        }
        //JOptionPane.showMessageDialog(display, "", "Error", JOptionPane.WARNING_MESSAGE);
    }
